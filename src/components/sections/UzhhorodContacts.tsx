          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  href="tel:+380974825097"
                  className="flex-1 px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all duration-300 text-center shadow-md hover:shadow-lg"
                >
                  {t('uzhhorod.contacts.call_button')}
                </a>
                <a
                  href="mailto:sergii@mission101.ai"
                  className="flex-1 px-6 py-3 bg-white border-2 border-blue-600 text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition-all duration-300 text-center"
                >
